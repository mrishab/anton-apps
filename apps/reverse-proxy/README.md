...
- `make subdomain-1-cert-setup SUBDOMAIN=<subdomain>`: Issue a new certificate for a subdomain under DOMAIN_1 (`<your-domain>`).
- `make subdomain-2-cert-setup SUBDOMAIN=<subdomain>`: Issue a new certificate for a subdomain under DOMAIN_2 (`<your-personal-domain>`).
- `make domain-1-cert-setup`: Issue a certificate for the root DOMAIN_1 (`<your-domain>`).
- `make domain-2-cert-setup`: Issue a certificate for the root DOMAIN_2 (`<your-personal-domain>`).
