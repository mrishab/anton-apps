...
APPS:=airflow calibre codeserver deluge dockovpn duplicati freshrss ghost immich jenkins jupyter lazylibrarian mediaserver nextcloud nexus nzbget ollama ombi open-webui pgadmin plex postiz prowlarr registry sftpgo sonarqube tautulli wikijs
